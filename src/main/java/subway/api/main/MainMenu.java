...
public enum MainMenu implements Menu {
    MANAGE_STATION("1", "역 관리", StationView::run),
    MANAGE_LINE("2", "노선 관리", LineView::run),
    MANAGE_SECTION("3", "구간 관리", SectionView::run),
    SHOW_SUBWAY_MAP("4", "지하철 노선도 출력", MainView::showSubwayMap),
